...
public class AttentManagerActivity extends SimpleFragmentActivity implements LocationRecListener {
	...
	protected Fragment[] createFragment() {
		return new Fragment[]{new AttendManageFragment(),new BaiduMapFragment()};
	}

	@Override
	protected int[] getAllFragmentId() {
		return new int[]{R.id.attent_manage_fragment_container,R.id.map_fragment_container};
	}

	@Override
	public void onLocationReceiveListener(Location loc) {
		FragmentManager fm = getFragmentManager();
		AttendManageFragment mf = (AttendManageFragment) fm.findFragmentById(R.id.attent_manage_fragment_container);
		mf.updateUI(loc);
	}
