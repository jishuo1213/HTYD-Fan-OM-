...
public class FTPUtils {
	...
	*//**
	 * FTP服务地址
	 *//*
	private static String ADDRESS = "ftp_server_address";
	*//**
	 * FTP登录用户名
	 *//*
	private static String USERNAME = "ftp_server_username";
	*//**
	 * FTP登录密码
	 *//*
	private static String PASSWORD = "ftp_server_password";

	*//**
	 * 构造方法
	 *//*
	public FTPClient sClient = null;
	...
	*//**
	...
	public void upload(String dir, boolean del, String... paths)
		 ...
		 * if (TextUtils.isEmpty(paths)) { return; }
	...
	*//**
	...
	public void delete(String... dirs) throws Exception {
		 ...
		 * if (TextUtils.isEmpty(dirs)) { return; }
	...
	*//**
	 ...
	 * @throws Exception
	 *//*
	public void setFTPDataTransferListener(final File file,
			final FTPDataTransferListener listener) {
		ThreadPool.runMethod(new Runnable() {
			@Override
			public void run() {
				try {
					getClient().append(file, listener);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
